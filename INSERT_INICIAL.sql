...
insert into departamento(nome) values('Help Desk');
...
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(5,'MARCOS CARVALHO NETO','2010-01-25','M');
...
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(5,'ANALDER MENINO','1999-01-01','M');
